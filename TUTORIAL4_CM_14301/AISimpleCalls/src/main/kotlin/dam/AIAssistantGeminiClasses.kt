...
class AIAssistantGeminiClasses(override val properties: Properties) : AIAssistant {
    ...
    // override var model = "gemini-2.0-flash" // NOK - deprecated/shut down, free tier quota is 0
    // override var model = "gemini-2.0-pro" // NOK - Most capable model (if available)
     override var model = "gemini-2.5-flash" // OK - current stable, free-tier eligible model
    ...
    override fun buildRequest(prompt: String): Request {
        ...
        val geminiRequest = GeminiRequest(
            ...
            , generationConfig = GenerationConfig(
                // Use TEMPERATURE/MAX_TOKENS from config.properties when defined,
                // otherwise fall back to the previous hardcoded defaults.
